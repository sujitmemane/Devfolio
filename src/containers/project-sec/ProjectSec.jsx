...
const ProjectSec = () => {
   const project=projectsArray.map(pro=>{
        return <ProjectElement key={pro.id} image={pro.image} heading={pro.heading} description={pro.description} tech={pro.tech}  demo={pro.demo} source={pro.source} change={pro.change} ></ProjectElement>
    })
  return (
