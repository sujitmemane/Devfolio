...
const Blog = () => {
  const blogElements=blogs.map(blog=>{
    return <BlogElement img={blog.img} heading={blog.heading}  date={blog.date} link={blog.link} ></BlogElement>
  })
  return (
        ...
        <div className='blogs-container'>
          <div className='first-row'>
              ...
              <div className='first-row-right'>
                <p className='info'>13 May 2022</p>
                <h1 className='blog-heading'>
                  <a href="https://sujitmemane.hashnode.dev/master-arrays-in-javascript" target="_blank">

                  Master Arrays in JavaScript  
                  </a>
                </h1>
                <p className='blog-desc'>
                  Arrays are an essential part of any programming language, and JavaScript is no exception. They allow us to store and 
                  manipulate multiple values in a single structure, making it easy to work with large amounts of data.
                </p>
              </div>
          </div>
